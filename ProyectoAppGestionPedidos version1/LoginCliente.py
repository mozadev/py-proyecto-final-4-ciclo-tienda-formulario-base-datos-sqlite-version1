...
class Login(Frame):
    ...
    def widgets(self):
        ...
        self.botonEnvio.config(font=('Comic Sans MS', 12), activeforeground="black", activebackground="white",
                               bg="white", cursor="hand2", border=1)
        ...
        self.botonRegresar.config(font=('Comic Sans MS', 12), cursor="hand2", bg="white", activebackground="white",
                                  border=0)
